...
export const OurMission = () => {
  return (
    <Layout>
      {/* Sección Hero - Ajustes responsivos */}
        ...
        <Row className={`${styles.row1} align-items-center`}>
          <Col xs={12} lg={6} className={`${styles.contentCol}`}>
            ...
            <p className={styles.description}>
              ...
              sostenibles. Se abordan aspectos como la planificación estratégica
              de ventas consultivas y optimización de procesos, siempre
              priorizando el propósito que impulse a esa organización.
            </p>
      ...
      {/* Sección de Cards de Soporte - Ajustes responsivos */}
          ...
          <Container className="my-5">
            ...
            <Row className="g-3 g-md-4 justify-content-center">
              ...
              <Col xs={12} sm={6} lg={4} xl={4}>
                <Card className={`${styles.card} h-100`}>
                  ...
                  <Card.Text className={styles.cardText}>
                    ...
                    fundamentales. Afronta los retos profesionales con claridad,
                    motivación y una renovada sensación de dirección y plenitud.
                  </Card.Text>
                </Card>
              </Col>
              ...
              <Col xs={12} sm={6} lg={4} xl={4}>
                <Card className={`${styles.card} h-100`}>
                  ...
                  <Card.Text className={styles.cardText}>
                    ...
                    tecnológica, garantizando el control y la eficiencia en los
              ...
              <Col xs={12} sm={6} lg={4} xl={4}>
                <Card className={`${styles.card} h-100`}>
                  ...
                  <Card.Text className={styles.cardText}>
                    ...
                    consciente. Lidera con autenticidad e integridad, inspirando
                    a quienes te rodean con tus acciones y principios.
                  </Card.Text>
                </Card>
              </Col>
              ...
              <Col xs={12} sm={6} lg={4} xl={4}>
                <Card className={`${styles.card} h-100`}>
                  <div className={styles.iconWrapper}>
                    <img src={icono} alt="icono" className="img-fluid" />
                  </div>
                  <Card.Title className={styles.cardTitle}>
      ...
      {/* Sección de Testimonios - Ajustes responsivos */}
      <Container>
        <Row>
          <Col xs={12} className="text-center mb-4">
        ...
        <Row className={`${styles.containerCards} g-3 g-md-4`}>
            ...
            <Card className={`${styles.cardTestimony} h-100`}>
              <Card.Body className="d-flex flex-column">
                <Card.Text className={`${styles.textCustomers} flex-grow-1`}>
                  "Hascunde me ayudó a redescubrir mi propósito y reequilibrar
                  mi vida. El apoyo estructurado fue exactamente lo que
                  necesitaba para prosperar en mi carrera y como padre."
                </Card.Text>
                <div
                ...
                >
                  ...
                  <div className="ms-3">
                    ...
                    <small className="text-muted">Entrepreneur & Father</small>
                  </div>
                </div>
              </Card.Body>
            </Card>
          ...
          <Col xs={12} md={6} xl={4} className="mb-4">
            <Card className={`${styles.cardTestimony} h-100`}>
              <Card.Body className="d-flex flex-column">
                <Card.Text className={`${styles.textCustomers} flex-grow-1`}>
                  "Encontré tranquilidad en medio del caos. Los principios de
                  consciencia de Hascunde transformaron mi enfoque diario para
          ...
          <Col xs={12} md={6} xl={4} className="mb-4">
            <Card className={`${styles.cardTestimony} h-100`}>
              <Card.Body className="d-flex flex-column">
                <Card.Text className={`${styles.textCustomers} flex-grow-1`}>
                  "El camino hacia la libertad parecía desalentador, pero con la
                  guía de Hascunde, he construido relaciones más fuertes y he
                  logrado metas que creía imposibles."
                </Card.Text>
                <div
                  className={`${styles.infoCustomers} d-flex align-items-center mt-auto`}
                >
      ...
      {/* Sección de Transformación - Ajustes responsivos */}
            ...
            <Col xs={12} sm={6} lg={3} className="mb-4">
              <Card className={`${styles.transformationCard} h-100`}>
                ...
                >
                  ...
                  >
                    Comience con una evaluación integral para identificar sus
                    desafíos y aspiraciones actuales.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
              ...
              <Card className={`${styles.transformationCard} h-100`}>
                ...
                >
                  ...
                  <Card.Text
                    className={`${styles.cardDescription} flex-grow-1`}
                  >
                    Consolida tu transformación, viviendo una vida equilibrada
                    con propósito y profunda libertad.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
      ...
      {/* Sección CTA Final - Ajustes responsivos */}
        ...
        <Row className="justify-content-center">
          <Col xs={12} lg={10} xl={8} className="text-center">
            ...
            <p className={styles.transformationText}>
              ...
              propósito profundo. Conéctate con nosotros para descubrir cómo
              Hascunde puede ayudarte en tu camino.
            </p>
